...
func (this PrePathogenicParam) AnnoGeneBase(filteredFile string) (anno.AnnoResult, error) {
	// 读取Genome输入文件
	...
	return gene.AnnoSnvs(filteredFile, this.GenePred, genome, this.AAshort, 16)
